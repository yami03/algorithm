// Codewars Link: https://www.codewars.com/kata/bouncing-balls/javascript
...
// if the height of the rebounding ball is stricty greater than the window parameter.
...
function bouncingBall(h, bounce, window) {
  ...
  for (i = 1; result > window; i++) {
    result = h * Math.pow(bounce, i + 1);
  }

  return i === 1 ? 1 : (i - 1) * 2 + 1;
}

assertEquals(bouncingBall(3.0, 0.66, 1.5), 3);
assertEquals(bouncingBall(30.0, 0.66, 1.5), 15);
