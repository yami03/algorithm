// Codewars: https://www.codewars.com/kata/59ea2a532a7accf2510000ce
/*
...
function Journey(object, crew, balloons) {
  this.totalWeight = object.weight + (crew * 80);
  this.ballonLift = 0.0048 * balloons;
}

Journey.prototype.isPossible = function () {
  return this.ballonLift >= this.totalWeight;
}